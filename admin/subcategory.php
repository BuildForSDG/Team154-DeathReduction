...
<label class="control-label" for="basicinput">Road</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Severity Name</label>
<div class="controls">
<input type="text" placeholder="Enter Severity Name"  name="subcategory" class="span8 tip" required>
</div>
</div>

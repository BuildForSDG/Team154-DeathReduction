...
<label class="control-label" for="basicinput">Road Name</label>
<div class="controls">
<input type="text" placeholder="Enter road Name"  name="category" class="span8 tip" required>
</div>
</div>

...
<label class="control-label" for="basicinput">County Name</label>
<div class="controls">
<input type="text" placeholder="Enter County Name"  name="state" class="span8 tip" required>
</div>
</div>

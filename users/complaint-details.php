...
<html lang="en">
  <head>
    ...
    <title>CMS | Report Details</title>
...
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Report Number : </b></label>
          		<div class="col-sm-4">
...
<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Road :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['catname']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Severity :</b> </label>
              <div class="col-sm-4">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Report Type :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['complaintType']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>County :</b></label>
              <div class="col-sm-4">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Nature of Report :</b></label>
              <div class="col-sm-4">
...
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Report Details </label>
              <div class="col-sm-10">

...
$complainno=$cmpn;
echo '<script> alert("Your report has been successfully filled and your reportno is  "+"'.$complainno.'")</script>';
}
?>
...
<html lang="en">
  <head>
    ...
    <title>CMS | User Register Report</title>
...
<label class="col-sm-2 col-sm-2 control-label">Severity</label>
 <div class="col-sm-4">
...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Road Accident</option>
                  <option value="General Query">Traffic</option>
                </select> 
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Nature of Report</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Report Details (max 2000 words) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Report Related Picture(if any) </label>
<div class="col-sm-6">
